function ShowSave_map(map_Cr,map_PCr,map_glycoNOE,B0map,B1map,T2w,images, Mask,result_path,Para)
...
for b =1:B1
    for s = Para.SelectedSlice
        ...
        %         colormap(ax1,gray)
        altered_colormap(ax1, gray) % test
